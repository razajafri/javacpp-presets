...
public class cudf implements InfoMapper {
    ...
    public void map(InfoMap infoMap) {
        infoMap.put(new Info("std::map<std::string,std::string>").pointerTypes("MapStringString").define())
						.put(new Info("rmm::device_vector<cudf::size_type>").pointerTypes("RmmDeviceVectorCudfSizeType").define())
						.put(new Info("rmm::device_vector<cudf::string_view>").pointerTypes("RmmDeviceVectorStringView").define())
						.put(new Info("rmm::device_vector<char>").pointerTypes("RmmDeviceVectorChar").define())
						.put(new Info("rmm::device_vector<size_type>").pointerTypes("RmmDeviceVectorSizeType").define())
						.put(new Info("std::pair<rmm::device_vector<char>,rmm::device_vector<size_type> >").pointerTypes("PairOfRmmDeviceVectorCharRmmDeviceVectorSizeType").define())
						.put(new Info("std::pair<char_utf8,char_utf8>").pointerTypes("PairOfCharUtf8CharUtf8").define())
						.put(new Info("std::pair<std::unique_ptr<rmm::device_buffer>,cudf::size_type>").pointerTypes("PairOfUniquePtrRmmDeviceBufferCudfSizeType").define())
			std::pair<std::unique_ptr<experimental::table>,std::vector<cudf::size_type> >
		.put(new Info("std::unique_ptr<cudf::column>").valueTypes("@MoveUniquePtr column").pointerTypes("@UniquePtr column").define())
		.put(new Info("std::unique_ptr<cudf::scalar>").valueTypes("@MoveUniquePtr scalar").pointerTypes("@UniquePtr scalar").define())
		.put(new Info("cudf::detail::table_view_base<cudf::column_view>").pointerTypes("TableViewBaseColumnView").define())
		.put(new Info("std::unique_ptr<table>").valueTypes("@MoveUniquePtr table").pointerTypes("@UniquePtr table").define())
		.put(new Info("cudf::detail::table_view_base<cudf::mutable_column_view>").pointerTypes("TableViewBaseMutableColumnView").define())
;
    }
}

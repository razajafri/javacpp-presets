...
public class column_view_base extends Pointer {
   ...
   *---------------------------------------------------------------------------**/
  public native @ByVal @NoException size_type is_empty();
   ...
   *---------------------------------------------------------------------------**/
  public native @ByVal size_type null_count(@ByVal size_type begin, @ByVal size_type end);
   ...
   *---------------------------------------------------------------------------**/
  public native @Cast("bool") boolean has_nulls(@ByVal size_type begin, @ByVal size_type end);
   ...
   *---------------------------------------------------------------------------**/
  public native @ByVal @NoException size_type offset();
}

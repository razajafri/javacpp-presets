...
public class mutable_column_view extends column_view_base {
   ...
   *---------------------------------------------------------------------------**/
  public mutable_column_view(@ByVal data_type type, @ByVal size_type size, Pointer data,
                        @Cast("cudf::bitmask_type*") IntPointer null_mask/*=nullptr*/,
                        @ByVal(nullValue = "cudf::size_type(cudf::UNKNOWN_NULL_COUNT)") size_type null_count,
                        @ByVal(nullValue = "cudf::size_type(0)") size_type offset,
                        @StdVector mutable_column_view children/*={}*/) { super((Pointer)null); allocate(type, size, data, null_mask, null_count, offset, children); }
  private native void allocate(@ByVal data_type type, @ByVal size_type size, Pointer data,
                        @Cast("cudf::bitmask_type*") IntPointer null_mask/*=nullptr*/,
                        @ByVal(nullValue = "cudf::size_type(cudf::UNKNOWN_NULL_COUNT)") size_type null_count,
                        @ByVal(nullValue = "cudf::size_type(0)") size_type offset,
                        @StdVector mutable_column_view children/*={}*/);
  public mutable_column_view(@ByVal data_type type, @ByVal size_type size, Pointer data) { super((Pointer)null); allocate(type, size, data); }
  private native void allocate(@ByVal data_type type, @ByVal size_type size, Pointer data);
  public mutable_column_view(@ByVal data_type type, @ByVal size_type size, Pointer data,
   ...
   *---------------------------------------------------------------------------**/
  public native @ByRef @NoException mutable_column_view child(@ByVal size_type child_index);

...
public class column_view extends column_view_base {
   ...
   *---------------------------------------------------------------------------**/
  public column_view(@ByVal data_type type, @ByVal size_type size, @Const Pointer data,
                @Cast("const cudf::bitmask_type*") IntPointer null_mask/*=nullptr*/,
                @ByVal(nullValue = "cudf::size_type(cudf::UNKNOWN_NULL_COUNT)") size_type null_count, @ByVal(nullValue = "cudf::size_type(0)") size_type offset,
                @StdVector column_view children/*={}*/) { super((Pointer)null); allocate(type, size, data, null_mask, null_count, offset, children); }
  private native void allocate(@ByVal data_type type, @ByVal size_type size, @Const Pointer data,
                @Cast("const cudf::bitmask_type*") IntPointer null_mask/*=nullptr*/,
                @ByVal(nullValue = "cudf::size_type(cudf::UNKNOWN_NULL_COUNT)") size_type null_count, @ByVal(nullValue = "cudf::size_type(0)") size_type offset,
                @StdVector column_view children/*={}*/);
  public column_view(@ByVal data_type type, @ByVal size_type size, @Const Pointer data) { super((Pointer)null); allocate(type, size, data); }
  private native void allocate(@ByVal data_type type, @ByVal size_type size, @Const Pointer data);
  public column_view(@ByVal data_type type, @ByVal size_type size, @Const Pointer data,
   ...
   *---------------------------------------------------------------------------**/
  public native @ByVal @NoException column_view child(@ByVal size_type child_index);

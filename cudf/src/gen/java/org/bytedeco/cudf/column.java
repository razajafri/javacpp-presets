...
public class column extends Pointer {
   ...
   *---------------------------------------------------------------------------**/
  public column(@Const @ByRef column other, @Cast("cudaStream_t") CUstream_st stream,
           device_memory_resource mr/*=rmm::mr::get_default_resource()*/) { super((Pointer)null); allocate(other, stream, mr); }
  private native void allocate(@Const @ByRef column other, @Cast("cudaStream_t") CUstream_st stream,
           device_memory_resource mr/*=rmm::mr::get_default_resource()*/);
  public column(@Const @ByRef column other, @Cast("cudaStream_t") CUstream_st stream) { super((Pointer)null); allocate(other, stream); }
  private native void allocate(@Const @ByRef column other, @Cast("cudaStream_t") CUstream_st stream);
   ...
   *---------------------------------------------------------------------------**/
  public column(
        @ByVal column_view view, @Cast("cudaStream_t") CUstream_st stream/*=0*/,
   ...
   *---------------------------------------------------------------------------**/
  public native @ByVal @NoException size_type size();
   ...
   *---------------------------------------------------------------------------**/
  public native @ByVal size_type null_count();
  ...
  public native void set_null_mask(@ByVal device_buffer new_null_mask,
                       @ByVal(nullValue = "cudf::size_type(cudf::UNKNOWN_NULL_COUNT)") size_type new_null_count);
  public native void set_null_mask(@ByVal device_buffer new_null_mask);
   ...
   *---------------------------------------------------------------------------**/
  public native void set_null_count(@ByVal size_type new_null_count);
   ...
   *---------------------------------------------------------------------------**/
  public native @ByVal @NoException size_type num_children();
   ...
   *---------------------------------------------------------------------------**/
  public native @ByRef @NoException column child(@ByVal size_type child_index);
  ...
  public static class contents extends Pointer {
    ...
    public native @StdVector @UniquePtr column children(); public native contents children(column setter);
  }
